...
2. Eight visible columns contain **Item code**, **Product/Service**, **Supplier price**, **Markup**, **Sell price**, **Group**, **Yield** and **Yield unit**. Product/Service is literal text, including any semicolon in the name. Yield is a single value; an unchanged Mixed value preserves differing saved yields. The locked unit column is derived from the groups.
