...
govern the final status; older checkpoints below are historical. Use current
receipts before claiming publication or a refreshed runtime. The main user
database is preserved; UI checks run against a disposable database.
